...
<body>
	<div id="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1> Report <small> Honor </small></h1>
            <ol class="breadcrumb">
              <li class="active"><i class="fa fa-user"></i> Halaman Report Honor</li>
            </ol>
            <table width="900">
            <tr>
          ...
          <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Report Honor</h3> 
              </div>
              <div class="panel-body">
				 ...
				 <form name="form1" method="get" action="" >
					...
					<table class="table table-bordered table-hover table-striped tablesorter">
                      ...
                      <tr>
						<th width="5%"><div align="center">No <i class="fa fa-sort"></i></div></th>
                        <th width="41%"> <div align="center">Nama <i class="fa fa-sort"></i></div></th>
                        <th width="25%"> <div align="center">Point<i class="fa fa-sort"></i></div></th>
                        <th width="29%"> <div align="center">Honor<i class="fa fa-sort"></i></div></th>
                      </tr>
					  <?php 
					  $batas = 10;

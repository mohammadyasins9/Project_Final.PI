      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
			...
			<li><a href=""><i class="fa fa-laptop"></i> Berita </a></li>
...
<?php } ?>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="alert alert-success alert-dismissable">
             ...
             User ID auto number jadi tidak perlu di isi, abaikan saja..
          </div>
        </div><!-- /.row -->
    ...
    <tr>
        <td><label for="user_id">Nama Pengguna <small>(digunakan untuk login)</small></label></td>
      ...
      <tr>
        ...
        <td><input name="fullname" type="text" class="form-control" id="fullname" placeholder="Jabatan Pengguna" required/></td>
      </tr>
      <tr>

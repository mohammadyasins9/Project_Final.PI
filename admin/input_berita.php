...
<?php } ?>
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Input Data<small> Berita </small></h1>
            <ol class="breadcrumb">
              <li class="active"><i class="fa fa-dashboard"></i> Halaman Input Data Berita </li>
            </ol>
            <table width="900">
            <tr>
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-laptop"></i> Input Data Berita  </h3>
              </div>
...
?>
    ...
    <table class="table table-condensed">
	   <tr>
			...
			<td><select name="id_wartawan" type="text" class="form-control" id="id_wartawan" />
	  ...
	  <!-- <tr>
			...
			<td><input name="nama_wartawan" type="text" class="form-control" id="nama_wartawan" value="<?php echo $data['nama_wartawan'];?>" readonly="readonly"/></td>
	   </tr>-->
	   <tr>
        <td><label for="tgl">Tanggal </label></td>
        <td><input name="tgl" type="text" class="form-control" id="tgl" value="<?php echo "".date("Y/m/d").""; ?>"/></td>		
      </tr>
	   <tr>
        <td><label for="judul">Judul </label></td>
        <td><input name="judul" type="text" class="form-control" id="judul" placeholder="Judul" /></td>		
      </tr>
      <tr>
        <td><label for="id_point">Kd_Point </label></td>
        <td><select name="id_point" type="text" class="form-control" id="id_point" />
			<option> ==== 	Point ====</option>
				<?php
	  ...
	  <tr>
        ...
        <td><input name="point" type="text" class="form-control" id="point" placeholder="Point" required/></td>	
      </tr>
      <tr>
        <td><label for="hal">Halaman</label></td>
        <td><select name="hal" type="text" class="form-control" id="hal" placeholder="Halaman" required/>
      ...
      <tr>
        <td><input type="submit"  value="Simpan Data"  class="btn btn-sm btn-primary"/>&nbsp;<a href="berita.php" class="btn btn-sm btn-primary">Kembali</a></td>
        </tr>
    </table>
    </form>
              </div>

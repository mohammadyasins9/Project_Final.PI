          ...
          <div class="col-lg-12">
            <div class="panel panel-primary">
			  ...
			  <div class="table-responsive">
				<?php
                    $query=mysql_query("select * from tb_berita WHERE id_wartawan='$_GET[kd]'");
			   ...
			   <tr>
				...
				<tr>
					...
					<td><input name="tgl" type="text" class="form-control" id="tgl" value="<?php echo $data['tgl'];?>" readonly="readonly"></td>
				</tr>
				<tr>
					<td><label for="judul"> Judul </label></td>
					<td><input name="judul" type="text" class="form-control" id="judul" value="<?php echo $data['judul'];?>" ></td>
				</tr>
				<tr>
					<td><label for="id_point"> Kd_Point </label></td>
					<td><input name="id_point" type="text" class="form-control" id="id_point" value="<?php echo $data['id_point'];?>" ></td>
				</tr>
				<tr>
					<td><label for="point"> Add_Point </label></td>
					<td><input name="point" type="text" class="form-control" id="point" value="<?php echo $data['point'];?>" ></td>
				</tr>
				<tr>
					<td><label for="hal"> Keterangan </label></td>
					<td><input name="hal" type="text" class="form-control" id="hal" value="<?php echo $data['hal'];?>" ></td>
				</tr>
				<tr>

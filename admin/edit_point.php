          ...
          <div class="col-lg-12">
            <div class="panel panel-primary">
			  ...
			  <div class="table-responsive">
				<?php
                    $query=mysql_query("select * from tb_point WHERE id_point='$_GET[kd]'");
					$data  = mysql_fetch_array($query);
				?>
			   <form action="update_point.php" method="post">
               <table class="table table-condensed">
			   <tr>
					<td><label for="id_point">Kode</label></td>
					<td><input name="id_point" type="text" class="form-control" id="id_point" value="<?php echo $data['id_point'];?>" readonly="readonly"/></td>
				</tr>
				<tr>
					<td><label for="score">Point </label></td>
					<td><input name="score" type="text" class="form-control" id="score" value="<?php echo $data['score'];?>" ></td>
				</tr>
				<tr>
					<td><label for="ket"> Keterangan </label></td>
					<td><input name="ket" type="text" class="form-control" id="ket" value="<?php echo $data['ket'];?>" ></td>
				</tr>	
				<tr>

...
<?php } ?>
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Tambah <small> Data Karyawan </small></h1>
            <ol class="breadcrumb">
              <li class="active"><i class="fa fa-user"></i> Halaman Tambah Data Karyawan </li>
            </ol>
            <table width="900">
            <tr>
    ...
    <table class="table table-condensed">
      <tr>
        ...
        <td><input name="id_wartawan" type="text" class="form-control" id="id_wartawan" placeholder="id_karyawan" required/></td>
      </tr>
      <tr>
        <td><label for="nama_wartawan">Nama Karyawan </label></td>
        <td><input name="nama_wartawan" type="text" class="form-control" id="nama_wartawan" placeholder="nama_karyawan" required/></td>
      </tr>
	  <tr>
	  ...
	  <tr>
        ...
        <td><input name="kota" type="text" class="form-control" id="kota" placeholder="Kota" required/></td>

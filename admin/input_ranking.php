...
<?php } ?>
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Input Data<small> Ranking </small></h1>
            <ol class="breadcrumb">
              <li class="active"><i class="fa fa-dashboard"></i> Halaman Input Data Ranking </li>
            </ol>
            <table width="900">
            <tr>
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-user"></i> Input Data Ranking  </h3>
              </div>
    ...
    <table class="table table-condensed">
	   <tr>
			...
			<td><input name="nama_wartawan" type="text" class="form-control" id="nama_wartawan" placeholder="Nama Karyawan" value="" " required/></td>
	   </tr>
	   <tr>
        <td><label for="jml">Jumlah Berita </label></td>
        <td><input name="jml" type="text" class="form-control" id="jml" placeholder="Jumlah Berita" value="" required/></td>		
      </tr>
	  <tr>
      ...
      <tr>
        <td><input type="submit"  value="Simpan Data"  class="btn btn-sm btn-primary"/>&nbsp;<a href="ranking.php" class="btn btn-sm btn-primary">Kembali</a></td>
        </tr>
    </table>
    </form>
              </div>
